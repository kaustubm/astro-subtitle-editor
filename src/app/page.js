...
export default function Home() {
  return (
    <div className="flex flex-col items-center min-h-screen">
      <main className="flex-1 w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block text-pink-600">Astro</span>
            <span className="block">Subtitle Editor</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Create production-quality subtitles for your videos with AI-powered
            transcription, precision editing, and professional styling that
            matches Netflix standards.
          </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Auto-generate accurate subtitles in multiple languages
                      using Deepgram's advanced AI.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Edit text, timing, and style with frame-accurate controls
                      in a professional interface.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      See your subtitles in context with real-time video preview
                      and instant updates.
                    </p>
                  </div>
                </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Export to SRT, VTT, and embedded MP4 in different quality
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Save, organize, and revisit your subtitle projects with
                      cloud-based storage.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2025 Netflix-Grade Subtitle Editor. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
